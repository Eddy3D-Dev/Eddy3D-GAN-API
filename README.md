...
Set `MODEL_URL` to this URL in your environment (see deployment sections below).
...
|----------|----------|---------|
| `MODEL_URL` | Yes | `https://huggingface.co/SustainableUrbanSystemsLab/UrbanWind-GAN/resolve/main/GAN-21-05-2023-23-Generative.onnx` |
